    ...
    <div className="relative w-full max-w-2xl mx-auto">
      <div className="relative group">
        ...
        <input
          ...
          className="w-full pl-8 pr-24 py-2.5 bg-bg-card border border-border text-text-primary text-sm placeholder:text-text-muted/70 focus:outline-none focus:border-accent/30 transition-colors"
        />
