...
function build(accent: string): Record<string, string> {
  return {
    ...
    'text-primary': '#e2e2e2',
    'text-secondary': tint('#a0a0a0', accent, 0.08),
    'text-muted': tint('#6b6b6b', accent, 0.06),
    'border': tint('#2a2a2a', accent, 0.05),
    'border-hover': tint('#3a3a3a', accent, 0.08),
    'badge-custom': accent,
    'badge-default': '#1e1e1e',
    'kbd-bg': '#0c0c0c',
    'kbd-border': tint('#2a2a2a', accent, 0.05),
    'warm': accent,
